...
export function Poll({ address }: { address: string }) {
  ...
  const readMethods = ["numMessages", "numSignups", "coordinatorPubKey"];
  ...
  const setStateVariables = [setNumMsg, setNumSignups, setCoordinatorPubKey];
